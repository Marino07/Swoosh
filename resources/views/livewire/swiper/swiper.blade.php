    ...
    <div class="relative h-full  md:h-[600px] w-full md:w-96 m-auto">
        ...
        <div
            ...
            <div
                    ...
                    <div class="spacey-y-3 py-2">
                        <h3 class="font-bold text-xl py-2"> Languages i know </h3>
                         <ul class="flex flex-wrap gap-3">
                            ...
                            <li class="border border-gray-500 rounded-2xl text-sm px-2.5 p-1.5">{{$language->name}}</li>
             ...
             <section class=" bg-white sticky bg-gradient-to-b from-white/50 to-white bottom-0 py-2 flex items-center justify-center gap-4 inset-x-0 mx-auto">
