        ...
        @foreach ($users as $user)
            <div @swipedright.window="console.log('right')" @swipedleft.window="console.log('left')"
                ...
                <div x-show="!profile" x-transition.duration.150ms.origin.bottom
                    ...
                    <div class="pointer-events-none">
                        ...
                        <span x-cloak :class="{ 'invisible': !swipingUp }"
                            class="border-2 rounded-md p-1 px-2 border-yellow-500 text-yellow-500 text-4xl capitalize font-extrabold   bottom-48 max-w-fit inset-x-0 mx-auto  -rotate-12 absolute z-5 ">
                            SUPER LIKE
                        </span>
                    </div>
                ...
                <div x-cloak x-show="profile" x-transition.duration.150ms.origin.top draggable="true"
                        ...
                        <div class="rounded-xl bg-green-200 h-24 px-4 py-2 max-w-fit flex gap-4 items-center">
                            ...
                            <div class="grid w-4/5">
                                ...
                                <span class="text-lg text-green-800">
                                    {{ strtoupper(str_replace('_', ' ', $user->relationship_goals?->value)) }} </span>
                    ...
                    <section
                        class=" bg-white sticky bg-gradient-to-b from-white/50 to-white bottom-0 py-2 flex items-center justify-center gap-4 inset-x-0 mx-auto">
                ...
                <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-300"
                    ...
                    <main class="relative w-auto flex flex-col gap-y-9">
                            <div class="mx-auto flex flex-col gap-2 items-center justify-center">
                                ...
                                <div class="mx-auto">
                                    <svg class="w-6 h-6 text-red " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="tinder">
                            ...
                            <div class="mx-auto flex flex-col gap-5">
                                ...
                                <button @click="modalOpen=false" class="bg-gradient-to-tr from-black/90 to-gray/5 text-white font-bold items-center px-3 py-2 rounded-full">
                                  Continue swiping
