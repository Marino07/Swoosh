...
<nav x-data="{ open: false }"
    class="sticky sm:relative top-0 left-0 right-0 w-full bg-gradient-to-b from-black/80 to-black/0">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-4 md:flex">
                    <x-nav-link class="text-white text-3xl font-black " :href="route('app')" :active="request()->routeIs('app')"
                        wire:navigate>
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link class="text-white text-3xl font-black" :href="route('app')" :active="request()->routeIs('app')"
                    ...
                    <x-nav-link class="font-black text-3xl text-white " :href="route('app')" :active="request()->routeIs('app')"
                        wire:navigate>
                        Language
                    </x-nav-link>
